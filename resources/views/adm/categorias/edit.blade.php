    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{asset('adm/categorias')}}"><i class="glyphicon glyphicon-list-alt"></i> Categorias</a></li>
                <li><i class="glyphicon glyphicon-pencil"></i> Editar Categoria</li>
      </ol>
    </section>
@stop
        ...
        <div class="col-md-12">
            <div class="box box-primary sombra_estatico">
                <div class="box-header">
                     <form action="{{asset('adm/categorias/update')}}" method="post" >

                        <div class="row">
                            <div class="col-md-12">
                                <label for="descricao">Descrição:</label>
                                <input name="descricao" type="text" maxlength="100" required="" value="{{$categoria->descricao}}" placeholder="Descrição" class="form-control"></input>
